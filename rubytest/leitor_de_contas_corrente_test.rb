...
class Leitor_de_contas_corrente_test < Test::Unit::TestCase
  ...
  def test_ler_arquivo_valido
    ...
    uma_conta_esperada = ContaCorrente.new 123, 10000
  ...
  def test_ler_arquivo_com_uma_conta_sem_saldo
    lista_com_contas = @leitor.ler_contas_do File.expand_path(File.dirname(__FILE__)) + '/../arquivos/arquivo_com_uma_conta_sem_saldo.csv'
    
    uma_conta_esperada = ContaCorrente.new 123, 60000
